 ...
 * Target :
 */
public class CaloriesProg implements IPrograms {

    WorkoutViewModel w;
    MainWorkoutTrainingFragment m;

    public CaloriesProg(WorkoutViewModel workoutViewModel, MainWorkoutTrainingFragment mainWorkoutTrainingFragment) {
    ...
    public void init() {
        ...
        w.caloriesLeft.set(w.targetCalories.get()); //剩餘距離
        //MaxIncline給最大值
        m.hideBtnSkip();
        if (isUs) {
         //   m.usWorkoutStopLong();
