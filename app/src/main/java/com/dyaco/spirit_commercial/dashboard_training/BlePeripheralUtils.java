...
//            super.onDescriptorReadRequest(device, requestId, offset, descriptor);
    ...
    public final static UUID SERVICE_DEVICE_INFORMATION = UUID.fromString("0000180a-0000-1000-8000-00805f9b34fb");
    @SuppressLint("MissingPermission")
...
//                (byte) 0x00, (byte) 0x0D, // Google 制造商 ID
//                // 自定义数据
//                (byte) 0x01, // 设备型号
//                (byte) 0x02, // 固件版本
//                // ...
//        };
        ...
        // 创建制造商数据
        byte[] manufacturerData = new byte[] {
                (byte) 0xFF, (byte) 0xFF, // Google 制造商 ID
                // 自定义数据
                (byte) 0xFF, // 设备型号
                (byte) 0xFF // 固件版本
                // ...
...
//                .addManufacturerData(0x000D, manufacturerData)
                .addManufacturerData(0x00E0, manufacturerData)
