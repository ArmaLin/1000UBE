...
public class TimeZoneBean {
    ...
    private Integer geoplugin_status;
    ...
    private Integer geoplugin_inEU;
    ...
    public Integer getGeoplugin_status() {
        return geoplugin_status;
    }

    public void setGeoplugin_status(Integer geoplugin_status) {
    ...
    public Integer getGeoplugin_inEU() {
        return geoplugin_inEU;
    }

    public void setGeoplugin_inEU(Integer geoplugin_inEU) {
        this.geoplugin_inEU = geoplugin_inEU;
    }

    public Boolean getGeoplugin_euVATrate() {
        return geoplugin_euVATrate;
    }

    public void setGeoplugin_euVATrate(Boolean geoplugin_euVATrate) {
    ...
    public void setGeoplugin_currencyConverter(Double geoplugin_currencyConverter) {
