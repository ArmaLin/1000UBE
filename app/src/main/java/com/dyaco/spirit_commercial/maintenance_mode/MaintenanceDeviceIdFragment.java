...
import com.dyaco.spirit_commercial.databinding.FragmentMaintenanceDeviceIdBinding;
...
public class MaintenanceDeviceIdFragment extends BaseBindingDialogFragment<FragmentMaintenanceDeviceIdBinding> {
    ...
    private void initDeviceSelected() {
        ...
        OptionsPickerView<String> pickAge = getBinding().pickDeviceId;
        pickAge.setData(list1);
        pickAge.setVisibleItems(8);
        pickAge.setNormalItemTextColor(ContextCompat.getColor(requireActivity().getApplicationContext(), R.color.color5a7085));
        ...
        pickAge.setSelectedItemTextColor(ContextCompat.getColor(requireActivity().getApplicationContext(), R.color.white));
