...
public class UserProfileEntity implements Parcelable {
    ...
    public int getAvatarTag() {
        return avatarTag;
    }

    public void setAvatarTag(int avatarTag) {
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeInt(avatarTag);

        parcel.writeSerializable(memberSince);
        parcel.writeSerializable(membershipExpirationDate);

        parcel.writeBoolean(isVip);
    }
    ...
    private UserProfileEntity(Parcel in) {
        ...
        avatarTag = in.readInt();

        memberSince = (java.util.Date) in.readSerializable();
        membershipExpirationDate = (java.util.Date) in.readSerializable();

        isVip = in.readBoolean();
    }
