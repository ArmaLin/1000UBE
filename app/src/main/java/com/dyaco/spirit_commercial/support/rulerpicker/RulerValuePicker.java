...
public final class RulerValuePicker extends FrameLayout implements ObservableHorizontalScrollView.ScrollChangedListener {
    ...
    public final static int DRAW_VIEW_TYPE_VIEW_DEFAULT = 0;
    public final static int DRAW_VIEW_TYPE_ALL_TEXT_VIEW = 1;
    public final static int DRAW_VIEW_TYPE_START_END_VIEW = 2;
    ...
    private void init(@Nullable AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            ...
            try { //Parse params
                ...
                if (a.hasValue(R.styleable.RulerValuePicker_ruler_text_is_all_show)) {
                    setTextIsAllShow (a.getBoolean(R.styleable.RulerValuePicker_ruler_text_is_all_show, false));
                }

                if (a.hasValue(R.styleable.RulerValuePicker_ruler_draw_view_type)) {
                    setDrawViewType (a.getInteger(R.styleable.RulerValuePicker_ruler_draw_view_type, 0));
                }

                if (a.hasValue(R.styleable.RulerValuePicker_ruler_end_text_margin_right)) {
                    setEndTextMarginRight (a.getInteger(R.styleable.RulerValuePicker_ruler_end_text_margin_right, 11));
                }

                if (a.hasValue(R.styleable.RulerValuePicker_ruler_start_text_margin_left)) {
                    setStartTextMarginLeft (a.getInteger(R.styleable.RulerValuePicker_ruler_start_text_margin_left, 11));
                }
            } finally {
                a.recycle();
            }
...
//            calculateNotchPath();
    ...
    private void calculateNotchPath() {
        mNotchPath.reset();
        mNotchPath.moveTo((getWidth() >> 1) - 30, 0);
        mNotchPath.lineTo(getWidth() >> 1, 40);
        mNotchPath.lineTo((getWidth() >> 1) + 30, 0);
    }
    /**
    ...
    public void onScrollChanged() {
        ...
        LogUtils.d("onScrollChanged: getCurrentValue:" + value);
     ...
     * @param isAllShow
     */
    public void setTextIsAllShow(final boolean isAllShow) {
        mRulerView.setTextIsAllShow(isAllShow);
    }
     ...
     *
     *  設定刻度的變化
     * @param drawViewType   0:預設字首,字尾小刻度不加文字顯示 , 1:全部刻度都加文字顯示, 2:字首字尾都加刻度顯示
     */
    public void setDrawViewType(final int drawViewType) {
        mRulerView.setDrawViewType(drawViewType);
    }
     ...
     * @param px
     */
    public void setEndTextMarginRight(final int px) {
        mRulerView.setEndTextMarginRight(px);
    }
     ...
     * @param px
     */
    public void setStartTextMarginLeft(final int px) {
        mRulerView.setStartTextMarginLeft(px);
    }
