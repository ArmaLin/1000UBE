...
public class TableAirForce {
    ...
    public TableAirForce() {}

    @Ignore
    public TableAirForce(int gender, int age_min, int age_max, int time_min, int time_max, int points, int category) {
        this.gender = gender;
