...
//
//public class DeviceSettingCheck {
//
//    /**
//     * 建立設定檔的資料庫，及檢查錯誤
//     */
//    public void checkDevice() {
//        SpiritDbManager.getInstance(getApp()).checkDevice(new DatabaseCallback<Integer>() {
//            @Override
//            public void onCount(Integer id) {
//                super.onCount(id);
//                Log.d("DEVICE_SETTING", "DeviceData已建立: " + id);
//
//                checkError();
//            }
//
...
//                super.onNoData();
//                //尚未建立
//                Log.d("DEVICE_SETTING", "DeviceData尚未建立");
//                insertDeviceData();
//            }
//        });
//    }
...
//        deviceEntity.setDeviceRunningTime(0);
//        deviceEntity.setDeviceStep(0);
//        deviceEntity.setDeviceDistance(0);
//
//        deviceEntity.setE050hour(0);
//        deviceEntity.setE052hour(0);
//        deviceEntity.setE0BAhour(0);
//
//        deviceEntity.setDeviceFirstLaunchTime(date);
...
//
//        SpiritDbManager.getInstance(getApp()).insertDeviceData(deviceEntity,
//                new DatabaseCallback<DeviceEntity>() {
//                    @Override
//                    public void onAdded(long rowId) {
//                        super.onAdded(rowId);
//                        Log.d("DEVICE_SETTING", "DeviceData建立完成 id:" + rowId);
//                    }
//
//                    @Override
//                    public void onError(String err) {
//                        super.onError(err);
//                        Log.d("DEVICE_SETTING", "DeviceData建立失敗:" + err);
//                    }
//                });
//    }
//
//    public void deleteDeviceData(int deviceId) {
//        SpiritDbManager.getInstance(getApp()).deleteDeviceData(deviceId,
//                new DatabaseCallback<DeviceEntity>() {
//                    @Override
//                    public void onDeleted() {
//                        super.onDeleted();
//                        Log.d("DEVICE_SETTING", "刪除完成: ");
//                    }
//
//                    @Override
//                    public void onError(String err) {
//                        super.onError(err);
//                        Log.d("DEVICE_SETTING", "刪除失敗: " + err);
//                    }
//                });
//    }
//
...
//                        checkError(deviceEntity);
//                    }
//                });
//    }
//
//    public void checkError(DeviceEntity deviceEntity) {
//
//        //Treadmill
//        if (check0x50(deviceEntity)) {
//            Log.d("DEVICE_SETTING", "0x50需要更換: ");
//            insertErrorMsg(OPT_SETTINGS.E0x50, deviceEntity);
//        } else {
//            Log.d("DEVICE_SETTING", "0x50不需要更換:");
//        }
//
//        if (check0x51(deviceEntity)) {
//            Log.d("DEVICE_SETTING", "0x51需要更換: ");
//            insertErrorMsg(OPT_SETTINGS.E0x51, deviceEntity);
//        } else {
//            Log.d("DEVICE_SETTING", "0x51不需要更換: ");
//        }
//
//        if (check0x52(deviceEntity)) {
//            Log.d("DEVICE_SETTING", "0x52需要更換: ");
//            insertErrorMsg(OPT_SETTINGS.E0x52, deviceEntity);
//        } else {
//            Log.d("DEVICE_SETTING", "0x52不需要更換: ");
//        }
//
//        if (check0x53(deviceEntity)) {
//            Log.d("DEVICE_SETTING", "0x53需要更換: ");
//            insertErrorMsg(OPT_SETTINGS.E0x53, deviceEntity);
//        } else {
//            Log.d("DEVICE_SETTING", "0x53不需要更換: ");
//        }
//
//        if (check0x54(deviceEntity)) {
//            Log.d("DEVICE_SETTING", "0x54需要更換: ");
//            insertErrorMsg(OPT_SETTINGS.E0x54, deviceEntity);
//        } else {
//            Log.d("DEVICE_SETTING", "0x54不需要更換: ");
//        }
//
//
//        //BIKE
//        if (check0xBA(deviceEntity)) {
//            Log.d("DEVICE_SETTING", "0xBA需要更換: ");
//            insertErrorMsg(OPT_SETTINGS.E0xBA, deviceEntity);
//        } else {
//            Log.d("DEVICE_SETTING", "0xBA不需要更換: ");
//        }
//
//        if (check0xBB(deviceEntity)) {
//            Log.d("DEVICE_SETTING", "0xBB需要更換: ");
//            insertErrorMsg(OPT_SETTINGS.E0xBB, deviceEntity);
//        } else {
//            Log.d("DEVICE_SETTING", "0xBB不需要更換: ");
//        }
//
//
//        //Recumbent Bike
//        if (check0xBC(deviceEntity)) {
//            Log.d("DEVICE_SETTING", "0xBC需要更換: ");
//            insertErrorMsg(OPT_SETTINGS.E0xBC, deviceEntity);
//        } else {
//            Log.d("DEVICE_SETTING", "0xBC不需要更換: ");
//        }
//
//        //Elliptical
//        if (check0xE0(deviceEntity)) {
//            Log.d("DEVICE_SETTING", "0xE0需要更換: ");
//            insertErrorMsg(OPT_SETTINGS.E0xE0, deviceEntity);
//        } else {
//            Log.d("DEVICE_SETTING", "0xE0不需要更換: ");
//        }
//
//        if (check0xE1(deviceEntity)) {
//            Log.d("DEVICE_SETTING", "0xE1需要更換: ");
//            insertErrorMsg(OPT_SETTINGS.E0xE1, deviceEntity);
//        } else {
//            Log.d("DEVICE_SETTING", "0xE1不需要更換: ");
//        }
//
//        if (check0xE2(deviceEntity)) {
//            Log.d("DEVICE_SETTING", "0xE2需要更換: ");
//            insertErrorMsg(OPT_SETTINGS.E0xE2, deviceEntity);
//        } else {
//            Log.d("DEVICE_SETTING", "0xE2不需要更換: ");
//        }
//    }
//
//    public void insertErrorMsg(String errorCode, DeviceEntity deviceEntity) {
//        String errorMsg = "";
//        Date date = Calendar.getInstance().getTime();
//        switch (errorCode) {
...
//        errorMsgEntity.setErrorCode(errorCode);
...
//                    public void onAdded(long rowId) {
//                        super.onAdded(rowId);
//                        Log.d("DEVICE_SETTING", "新增ErrorMsg: ");
//
...
//                        public void onAdded(long rowId) {
//                            super.onAdded(rowId);
//                            Log.d("DEVICE_SETTING", "新增ErrorMsg: " + rowId);
//                        }
//                        @Override
//                        public void onError(String err) {
//                            super.onError(err);
...
//     * 1200 hour = 50 day
//     */
//    private boolean check0x50(DeviceEntity deviceEntity) {
...
//     * Each quarterly = 90 day
//     */
//    private boolean check0x51(DeviceEntity deviceEntity) {
//        Log.d("DEVICE_SETTING", "---");
...
//     * 2 year = 720 day
//     */
//    private boolean check0x52(DeviceEntity deviceEntity) {
//        Log.d("DEVICE_SETTING", "---");
...
//     * 360 day
//     */
//    private boolean check0x53(DeviceEntity deviceEntity) {
//        Log.d("DEVICE_SETTING", "---");
...
//     * 720 day
//     */
//    private boolean check0x54(DeviceEntity deviceEntity) {
//        Log.d("DEVICE_SETTING", "---");
...
//     * 360 day  ,166.6 day
//     */
//    private boolean check0xBA(DeviceEntity deviceEntity) {
//        Log.d("DEVICE_SETTING", "---");
...
//     * Each 2 years
//     */
//    private boolean check0xBB(DeviceEntity deviceEntity) {
//        Log.d("DEVICE_SETTING", "---");
...
//     * Each half year
//     */
//    private boolean check0xBC(DeviceEntity deviceEntity) {
//        Log.d("DEVICE_SETTING", "---");
...
//     * Each 1 year
//     */
//    private boolean check0xE0(DeviceEntity deviceEntity) {
//        Log.d("DEVICE_SETTING", "---");
...
//     * Each 2 years
//     */
//    private boolean check0xE1(DeviceEntity deviceEntity) {
//        Log.d("DEVICE_SETTING", "---");
...
//     * 90 day
//     */
//    private boolean check0xE2(DeviceEntity deviceEntity) {
//        Log.d("DEVICE_SETTING", "---");
...
//
//    /**
//     * ErrorMsg新增完畢，重置Device設定的時間
//     *
//     * @param deviceEntity
//     */
//    public void updateDeviceData(DeviceEntity deviceEntity) {
//        SpiritDbManager.getInstance(getApp()).updateDeviceData(deviceEntity,
//                new DatabaseCallback<DeviceEntity>() {
//                    @Override
//                    public void onUpdated() {
//                        super.onUpdated();
//                        Log.d("DEVICE_SETTING", "Device資料歸0");
//                    }
//
//                    @Override
//                    public void onError(String err) {
//                        super.onError(err);
//                        Log.d("DEVICE_SETTING", "Device資料歸0 儲存失敗");
//                    }
//                });
//    }
//
...
//
//                        Log.d("DEVICE_SETTING", "ErrorMsg:" + errorMsgEntity.toString());
//                    }
//                });
//    }
//
...
//                        Log.d("GEM_DEVICE", "MACHINE_LOG TYPE: " + MACHINE_LOG.find(Integer.parseInt(errorCode, 16)));
//                    }
//
...
//
////        // 回傳ODO 資料給APP
//        DeviceGEM.FITNESS_EQUIPMENT_TYPE type = DeviceGEM.FITNESS_EQUIPMENT_TYPE.TREADMILL;
//
//        SpiritDbManager.getInstance(getApp()).getDeviceData(
//                new DatabaseCallback<DeviceEntity>() {
//                    @Override
//                    public void onDataLoadedBean(DeviceEntity deviceEntity) {
//                        super.onDataLoadedBean(deviceEntity);
//                        int hour = (int) deviceEntity.getDeviceRunningTime();
//                        int distance = (int) deviceEntity.getDeviceDistance();
//                        int steps = (int) deviceEntity.getDeviceStep();
//
//                        long day = TimeUnit.SECONDS.toDays(deviceEntity.getDeviceRunningTime());
//                        long hours = TimeUnit.SECONDS.toHours(deviceEntity.getDeviceRunningTime()) - (day * 24);
//                        hour = (int) hours;
//                        Log.d("GEM_DEVICE", "onDataLoadedBean: HOUR:" +hour +",DISTANCE:"+distance +"STEPS,"+steps);
//                        getDeviceGEM().customMessageSendOdoInfo(type, hour, distance, steps);
//                    }
//                });
//    }
//}
