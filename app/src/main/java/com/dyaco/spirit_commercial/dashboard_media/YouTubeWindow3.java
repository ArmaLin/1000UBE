...
public class YouTubeWindow3 implements AdvancedWebView.Listener {
  ...
  //  private final View youBack;
    ...
    public YouTubeWindow3(Context context) {

        initHookWebView();

        View view = (ConstraintLayout) LayoutInflater.from(context).inflate(R.layout.window_youtube, null);
...
//            advancedWebView.requestFocus(View.FOCUS_DOWN);
//            advancedWebView.requestFocusFromTouch();
//            advancedWebView.setOnTouchListener(new View.OnTouchListener() {
//                @Override
